...
static void test_skb_alloc(void) {
...
/* Test sk_buff push */
static void test_skb_push(void) {
    sk_buff_t* skb = skb_alloc(1024);
    TEST_ASSERT_NOT_NULL(skb);
...
/* Test sk_buff pull */
static void test_skb_pull(void) {
    sk_buff_t* skb = skb_alloc(1024);
    TEST_ASSERT_NOT_NULL(skb);
...
static void test_hton_ntoh(void) {
...
/* Test sk_buff clone */
static void test_skb_clone(void) {
    sk_buff_t* skb = skb_alloc(1024);
    TEST_ASSERT_NOT_NULL(skb);
